          ...
          <Card className="shadow">
            <Card.Body>
              <div className="mb-3 mt-4">
                ...
                <h2 className="fw-bold text-uppercase mb-2 h1 text-center mb-3" style={{color:"#466ece",fontFamily:"verdana",fontWeight:"bolder"}} > ADD New Post<CirclePlus size={40} color={"#466ece"}  className="ml-1 pb-1"/></h2>
                <p className="mb-5 text-center" style={{fontFamily:"cursive"}}>Please enter your details to post something!</p>
                <Form>
                <Row className="mb-3">
                <Form.Group controlId="formFile" className="mb-3">
        <Form.Label>Please choose one required image to Post...</Form.Label>
        <Form.Control type="file" />
      </Form.Group>
                 
                    <Form.Group as={Col} className="mb-3" controlId="formFullName">
                      <Form.Label className="text-center">Enter full name</Form.Label>
                      <Form.Control type="text" placeholder="Enter full name" />
                    </Form.Group>

                    <Form.Group as={Col} className="mb-3" controlId="formPhoneNumber">
                      <Form.Label>Enter time-Duration</Form.Label>
                      <Form.Control type="date" placeholder="Enter time-Duration" />
                    </Form.Group>
                  </Row>
                  <Row className="mb-3">
      ...
      {!show ? (
        <header>
          <div className="p-5 text-center bg-body-tertiary">
            <h1 className="mb-3 text-primary" style={{ fontFamily: "verdana", fontWeight: "bold" }}>
              Do you really want to post something?
            </h1>
            <h6 className="mb-3 text-secondary">Please confirm before posting a new page</h6>
            <button
